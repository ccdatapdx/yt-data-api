...
class YouTubeComments:
    ...
    def __init__(self,channel_id:str,date_before:datetime,date_after:datetime) -> None:
        ...
        self.video_comments_ids_list = []
        self.video_comments_dates_list = []
        self.video_comment_reply_counts_list = []
        ...
        if results:
            while results:
                for result in results:
                    ...
                    self.video_comments_list.append(comment)
                    self.video_comments_ids_list.append(comment_id)
                    self.video_comments_dates_list.append(comment_date)
                    self.video_comment_reply_counts_list.append(comment_reply_count)
                    comments_final = {'comment_text':self.video_comments_list,
                                      'comment_id':self.video_comments_ids_list,
                                      'comment_date':self.video_comments_dates_list,
                                      'comment_reply_counts':self.video_comment_reply_counts_list}
